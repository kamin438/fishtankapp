...
:root { --polaris-version-number: '9.8.0'; }
...
.Polaris-DataTable__StickyHeaderEnabled [data-sticky-active] .Polaris-DataTable__StickyTable .Polaris-DataTable__Heading { visibility: visible; }
...
.Polaris-DataTable__StickyHeaderEnabled .Polaris-DataTable__StickyTable { position: relative; top: 0; left: 0; right: 0; visibility: hidden; z-index: var(--p-z-1); }

.Polaris-DataTable__StickyHeaderEnabled .Polaris-DataTable__StickyTableHeader { position: absolute; display: flex; flex-direction: column; width: 100%; overflow: hidden; }

.Polaris-DataTable__StickyHeaderEnabled .Polaris-DataTable__StickyTableHeader:not(.Polaris-DataTable__StickyTableHeader--isSticky) { top: -624.9375rem; left: -624.9375rem; }

.Polaris-DataTable__StickyHeaderEnabled .Polaris-DataTable__StickyHeaderCell { flex-shrink: 0; }
...
.Polaris-DataTable__StickyHeaderEnabled .Polaris-DataTable__StickyTableHeadingsRow { flex: 1 1 auto; display: flex; overflow-x: auto; background-color: var(--p-surface); justify-content: space-between; scrollbar-width: none; }

.Polaris-DataTable__StickyHeaderEnabled .Polaris-DataTable__StickyTableHeadingsRow::-webkit-scrollbar { -webkit-appearance: none; appearance: none; height: 0; width: 0; }

.Polaris-DataTable__StickyHeaderEnabled .Polaris-DataTable__StickyTableHeader--isSticky { visibility: visible; background-color: var(--p-surface); box-shadow: var(--p-shadow-base); }
